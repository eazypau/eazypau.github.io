...
const vueuseHead_218dd113 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_fb93e1f2 = defineNuxtPlugin((nuxtApp) => {
...
const NuxtChild = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$3]]);
const layouts = {};
...
const routes = [
  {
    "name": "index",
    "path": "/",
    "file": "C:/Users/PO YZ/Documents/Gitbash/Testing-diff-lib-or-platform/nuxt3-playground/pages/index.vue",
    "children": [],
...
const router_5ff5b4f8 = defineNuxtPlugin((nuxtApp) => {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "py-5 px-10 bg-amber-300" }, _attrs))}><p class="font-semibold text-[50px]">home page</p><p>test deployment to github page</p></div>`);
}
